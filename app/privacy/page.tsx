export const metadata = {
  title: "プライバシーポリシー | PetQ（ペットキュー）",
  description: "PetQのプライバシーポリシーです",
};
      ...
      <div className="prose prose-gray max-w-none space-y-6">
        <section>
          <p className="text-muted-foreground">
            PetQ（以下、「当サービス」といいます。）は、本ウェブサイト上で提供するサービス（以下、「本サービス」といいます。）における、ユーザーの個人情報の取扱いについて、以下のとおりプライバシーポリシー（以下、「本ポリシー」といいます。）を定めます。
          </p>
        </section>
        ...
        <section>
          ...
          <ol className="list-decimal list-inside space-y-2 text-muted-foreground">
            <li>当サービスは、本人から個人情報の開示を求められたときは、本人に対し、遅滞なくこれを開示します。ただし、開示することにより次のいずれかに該当する場合は、その全部または一部を開示しないこともあり、開示しない決定をした場合には、その旨を遅滞なく通知します。なお、個人情報の開示に際しては、1件あたり1,000円の手数料を申し受けます。
              <ul className="list-disc list-inside ml-6 mt-2">
        ...
        <section>
          ...
          <ol className="list-decimal list-inside space-y-2 text-muted-foreground">
            ...
            <li>当サービスは、前項の規定に基づき訂正等を行った場合、または訂正等を行わない旨の決定をしたときは、遅滞なく、これをユーザーに通知します。</li>
          </ol>
        </section>
        ...
        <section>
          ...
          <div className="mt-4 p-4 bg-gray-50 rounded-lg">
            <p className="text-muted-foreground">
              Eメールアドレス：support@petq.jp
            </p>
          </div>
        </section>

        <section className="mt-8 pt-8 border-t">
          <p className="text-sm text-muted-foreground">制定日：2024年12月1日</p>
        </section>
      </div>
    </div>
  );
