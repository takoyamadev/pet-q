export const metadata = {
  title: "利用規約 | PetQ（ペットキュー）",
  description: "PetQサービスの利用規約です",
};
      ...
      <div className="prose prose-gray max-w-none space-y-6">
        <section>
          ...
          <p className="text-muted-foreground">
            この利用規約（以下、「本規約」といいます。）は、PetQ（以下、「当サービス」といいます。）の利用条件を定めるものです。
        ...
        <section>
          ...
          <ol className="list-decimal list-inside space-y-2 text-muted-foreground">
            <li>当サービスにおいては、登録希望者が本規約に同意の上、当社の定める方法によって利用登録を申請し、当社がこれを承認することによって、利用登録が完了するものとします。</li>
        ...
        <section>
          ...
          <ol className="list-decimal list-inside space-y-2 text-muted-foreground">
            ...
            <li>当社は、何らかの理由によって責任を負う場合にも、通常生じうる損害の範囲内においてのみ賠償の責任を負うものとします。</li>
